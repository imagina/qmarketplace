                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-3 q-mb-lg text-center">
                  <div class="row q-col-gutter-xs items-center justify-end">
                    <div class="col-xs-auto col-sm-auto col-md-auto col-lg-12">
                      <q-card @click="ratingStore=true" class="card-circle text-center q-mb-sm" style="cursor: pointer">
            ...
            <div class="row">
              ...
              <div class="col-auto q-pr-md">
                ...
                <q-btn flat icon="fas fa-heart" color="store-secondary"
                       :to="{name:'stores.product.wishlist',params:{slug:storeData.slug}}"/>
                <div class="line-vertical"></div>
        ...
        <div class="top-mobile" style="margin-top: -75px;">
          ...
          <div class="q-container">
            ...
            <q-toolbar class="bg-white shadow-4">
              ...
              <q-btn flat dense @click="$router.push({name: 'stores.about', params : {slug:storeData.slug}})"
                     icon="fas fa-map-marker-alt" color="store-primary"/>
              <chat class="chat" color="store-primary" type="0" v-if="$store.state.quserAuth.userId"></chat>
              <q-toolbar-title>
              </q-toolbar-title>
              <q-btn flat dense @click="modal = !modal" icon="fas fa-search" color="store-primary"/>
              <q-btn flat dense icon="fas fa-heart" :to="{name:'stores.product.wishlist',params:{slug:storeData.slug}}"
                     color="store-primary"/>
