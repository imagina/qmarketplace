      ...
      <div class="q-container">
         <div class="row">
            <div class="col-12">
               ...
               <q-card class="rounded-md q-mb-xl">
                  ...
                  <q-card-actions align="right" no-caps class="q-px-lg q-pt-lg q-pb-none" v-if="storeId">
                     <q-btn class="rounded-sm  font-family-secondary" no-caps color="primary" icon="fas fa-eye"
                            label="Vista previa"/>
                  </q-card-actions>

                  <q-card-section class="q-pa-xl form-general">

                     <div class="text-h5 text-primary q-mb-xs font-family-secondary capitalize">Tienda
                        {{company.name}}
                     </div>
            ...
            <div class="col-12 text-right">
               <div class="q-mt-lg">
                  <q-btn class="bg-primary text-white btn-arrow-send-pink" @click="updateStore()"
                         v-if="storeId!=null && storeId!=false">Actualizar
                  </q-btn>
