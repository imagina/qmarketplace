         ...
         <div class="col-12">
            ...
            <q-card class="rounded-sm">
               ...
               <q-card-section class="q-pa-lg">
                  <div class="row">
                     <div class="col-md-3">
                        <div class="text-bold">{{$tr('qcommerce.layout.orderStatus')}}: &nbsp </div>
                     </div>
                     <div class="col-md-9">
                        {{order.statusName}}
                     </div>
                  ...
                  <div class="row">
                     <div class="col-md-3">
                        <div class="text-bold">{{$tr('qcommerce.layout.orderDate')}}: &nbsp </div>
                     </div>
                     <div class="col-md-9">{{(order.createdAt)}}</div>
                  </div>
                  <div class="row">
                     <div class="col-md-3">
                        <div class="text-bold">{{$tr('qcommerce.layout.placedFromIP')}}: &nbsp </div>
                     </div>
                     <div class="col-md-9">{{order.ip}}</div>
                  </div>
                  <div class="row">
                     <div class="col-md-3">
                        <div class="text-bold">{{$tr('ui.form.name')}}: &nbsp </div>
                     </div>
                     <div class="col-md-9">
                  ...
                  <div class="row">
                     <div class="col-md-3">
                        <div class="text-bold">{{$tr('ui.form.email')}}: &nbsp </div>
                     </div>
                     <div class="col-md-9">
                  ...
                  <div class="row">
                     <div class="col-md-3">
                        <div class="text-bold">{{$tr('ui.form.phone')}}: &nbsp </div>
                     </div>
                  ...
                  <div class="row">
                     <div class="col-md-3">
                        <b>{{$tr('qcommerce.layout.billingAddress')}}: &nbsp </b>
                     </div>
                     <div class="col-md-9">
            ...
            <q-card class="rounded-sm q-mt-lg">
               ...
               <q-card-section>
                  <div class="text-right">
                     <q-btn class=" rounded-sm" color="primary" icon="fas fa-edit" label="Agregar estado"
                            @click="modal = !modal"/>
                  </div>
               </q-card-section>
         ...
         getOrder() {
            ...
            this.$crud.show('apiRoutes.qcommerce.orders', criteria, params)
                .then(response => {
                   ...
                   this.order.customer.fields = this.$helper.convertToFrontField(response.data.customer.fields);
                   this.loading = false
                })
                .catch(error => {
                   this.loading = false
