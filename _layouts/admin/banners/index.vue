          ...
          <div class="col-12 q-pa-md">
            ...
            <div class="float-right">
              ...
              <q-btn
                ...
                @click="showSliderModal(false)" v-if="$auth.hasAccess('marketplace.bannerpositions.create')"/>
              <!--Button refresh data-->
              <q-btn
              ...
              <div class="col-12 col-sm-4 col-md-3" v-for="slider in dataTable" :key="slider.id">
                ...
                <div class="row q-py-xs justify-end bg-grey-3">
                  ...
                  <q-btn
                    ...
                    :to="{name: 'qmarketplace.admin.banners.positions.show', params: {id: slider.id}}"
                    v-if="$auth.hasAccess('marketplace.bannerpositions.edit') && hasPermissionRecordMAster(slider).edit">
