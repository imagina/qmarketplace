                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xs-12 col-sm-4 q-pa-sm">
                                                            <q-btn
                                                                    ...
                                                                    size="md"
                                                                    class=" text-weight-bold rounded-sm full-width"
                                                                    color="primary"
                                                                    label="Validar cupón"/>
                                                        </div>
                                                        <div class="col-xs-12" v-if="couponMessage"><span
                                                                v-bind:class="couponMessage.status?'text-positive':'text-negative'">{{couponMessage.message}}</span>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="q-mb-md">
                                                    ...
                                                    <div class="row" v-if="addresses.length">
                                                        ...
                                                        <div class="col-xs-12 col-sm-4 q-pa-md">
                                                            <q-btn
                                                                    ...
                                                                    size="md"
                                                                    class=" text-weight-bold rounded-sm q-mb-md full-width"
                                                                    color="primary"
                                                    ...
                                                    <div class="row" v-else>
                                                        <q-btn
                                                                @click="modalAddress= !modalAddress"
                                                                size="md"
                                                                class=" text-weight-bold rounded-sm q-mb-md"
                                                                color="primary"
                                                                label="Nueva Direccion"/>
                                                    </div>
                                                    <q-dialog v-model="modalAddress" persistent>
                                                        <q-card style="min-width: 350px">
                                                            <q-card-section>
                                                                <div class="text-h6 text-primary text-weight-bold">Nueva
                                                                    Direccion
                                                                </div>
                                                            </q-card-section>
                                                            <q-form autocorrect="off" autocomplete="off"
                                                                    ref="formContent" class="box"
                                                                    @submit="addAddress()"
                                                                    ...
                                                                    <div class="col-xs-12 col-sm-6 q-px-sm">
                                                                        ...
                                                                        <div class="q-mb-sm">
                                                                            <p class="caption q-mb-none">
                                                                                {{$tr('ui.form.address')}}</p>
                                                                            <q-input dense type="text"
                                                                                     v-model="form.paymentAddress1"
                                                                ...
                                                                <q-card-actions align="right" class="text-primary">
                                                                    <q-btn flat type="reset" label="Cancel"
                                                                           v-close-popup></q-btn>
                            ...
                            <div class="col">
                                ...
                                <q-card class="rounded-sm bg-white plan">
                                    <q-card-section style="color: #333333;">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <p class="q-subheading q-my-md">
                                                    {{$tr('qsubscription.layout.form.checkout.shipping')}}</p>
                                            </div>
                                            <div class="col-6 text-right">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <p class="q-subheading q-my-md">
                                                    {{$tr('qsubscription.layout.form.checkout.discount')}}</p>
                                            </div>
                                            <div class="col-6 text-right">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6 text-right">
                                                <p v-if="cart"
                                                   class="q-subheading text-weight-bold text-primary q-my-md">$
                                                    {{total}}</p>
                                                <p v-else class="q-subheading text-weight-bold text-primary q-my-md">$
                                                    0</p>
                                            </div>
                                        </div>
                                        <hr class="line-grey">
                                        <q-btn size="lg"
                                               @click="submitOrder"
                                               class="capitalize text-weight-bold full-width rounded-sm q-mb-md"
                                               color="primary"
                                               :label="$tr('qsubscription.layout.form.checkout.finalizePurchase')"/>
                                    </q-card-section>
