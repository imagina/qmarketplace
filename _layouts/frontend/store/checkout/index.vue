<template>
  <q-page class="page">
    ...
    <div class="bg-fondo q-px-sm q-py-xl">
            ...
            <q-card class="rounded-sm bg-white q-mb-xl">
              ...
              <q-card-section class="q-pa-xl form-general">
                ...
                <div class="row q-col-gutter-lg justify-center">
                  ...
                  <q-radio v-model="form.shippingMethodId" v-for="(shipMethod,index) in shippingMethods" :key="shipMethod.id" :val="shipMethod.id" :label="shipMethod.title" />
      ...
      <q-radio v-model="form.paymentMethodId" v-for="(payMethod,index) in paymentMethods" :key="payMethod.id" :val="payMethod.id" :label="payMethod.title" />
